package com.belmar.bookclub.controllers;
...
import com.belmar.bookclub.services.BookService;
import com.belmar.bookclub.services.UserService;
...
public class HomeController {
	...
	public String createBook(@Valid @ModelAttribute("book") Book book, BindingResult result, HttpSession session) {
		...
		// get the whole logged in user object using that id
		User loggedInUserObj = this.userServ.findUser(idOfLoggedInUser);
		
		
		//set the book uploader to be that logged in user object
