public class Conditionals {
    public static void main(String [] args){
        ...
        if(numberOfFur >= 600000){
            System.out.println("You may be a Husky!");
        }else if(numberOfFur == 5){
            System.out.println("You may not be a furry pup.");
        }else{
            System.out.println("You might be a lizzard");
        }
